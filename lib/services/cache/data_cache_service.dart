...
/// 数据缓存服务
///
/// 缓存推荐歌单、每日推荐、歌单详情、用户歌单等业务数据。
/// 基于 SharedPreferences 存储，24小时过期，被 MusicRepository 使用。
class DataCacheService {
  ...
  Future<bool> saveRecommendedPlaylists(List<RecommendedPlaylist> playlists) async {
    final jsonList = playlists
        ...
        .toList();
    final result = await _saveJson(_playlistsCacheKey, _playlistsTimestampKey, {'items': jsonList});
