...
class StorageConfigService {
  ...
  Future<bool> clearConfig() async {
    try {
      ...
      await _deleteSecure(supabaseKey);
      await _deleteSecure(r2AccessKey);
      await _deleteSecure(r2SecretKey);
      return _safePrefs.remove(_configKey);
    } catch (e) {
      Logger.error('清除配置失败', e, null, 'StorageConfig');
      return false;
    }
  }
